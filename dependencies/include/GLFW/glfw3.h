 ...
 *  systems, either when no window system is running_chunkloader or the program was run from
 ...
 *  @ref glfwGetVersion function provides the version of the running_chunkloader library
